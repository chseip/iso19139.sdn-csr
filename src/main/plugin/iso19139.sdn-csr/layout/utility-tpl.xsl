...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-iso19139.sdn-csr-is-service">
    <xsl:value-of
            select="count($metadata/gmd:identificationInfo/srv:SV_ServiceIdentification) > 0"/>
  </xsl:template>

  <xsl:template name="get-iso19139.sdn-csr-extents-as-json">[
  ...
  <xsl:template name="get-iso19139.sdn-csr-online-source-config">

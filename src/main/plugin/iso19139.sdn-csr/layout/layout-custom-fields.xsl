...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Readonly elements -->
  <xsl:template mode="mode-iso19139.sdn-csr" priority="2000" match="gmd:fileIdentifier|gmd:dateStamp">
  ...
  -->
  <xsl:template mode="mode-iso19139.sdn-csr" priority="100" match="gmd:topicCategory">
  ...
  -->
  <xsl:template mode="mode-iso19139.sdn-csr" match="gts:TM_PeriodDuration|gml:duration" priority="200">
  ...
  <xsl:template mode="mode-iso19139.sdn-csr" match="gml:beginPosition|gml:endPosition|gml:timePosition"
    priority="200">
  ...
  <xsl:template mode="mode-iso19139.sdn-csr" match="gmd:EX_GeographicBoundingBox" priority="2000">

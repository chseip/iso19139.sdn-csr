...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template mode="mode-iso19139.sdn-csr" priority="2000" match="
  ...
  <xsl:template mode="mode-iso19139.sdn-csr" match="gmd:MD_Keywords" priority="2000">
      ...
      <xsl:when test="$thesaurusConfig">
        ...
        <xsl:variable name="transformations"
                      ...
                      select="if ($thesaurusConfig/@transformations != '')
                              ...
                              else 'to-iso19139.sdn-csr-keyword,to-iso19139.sdn-csr-keyword-with-anchor,to-iso19139.sdn-csr-keyword-as-xlink'"/>

        <!-- Get current transformation mode based on XML fragment analysis -->
        <xsl:variable name="transformation"
          select="if (parent::node()/@xlink:href) then 'to-iso19139.sdn-csr-keyword-as-xlink'
          else if (count(gmd:keyword/gmx:Anchor) > 0)
          then 'to-iso19139.sdn-csr-keyword-with-anchor' 
